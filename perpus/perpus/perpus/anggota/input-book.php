                    ...
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-book.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="judul_buku" type="text" id="judul_buku" class="form-control" autocomplete="off" placeholder="Judul Buku" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Penulis</label>
                                        <div class="col-sm-8">
                                            <input name="penulis" type="text" id="penulis" class="form-control" autocomplete="off" placeholder="Penulis" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="jumlah_halaman" type="text" id="jumlah_halaman" class="form-control" autocomplete="off" placeholder="Jumlah Halaman" required="" />
                                        </div>
                                    </div>
