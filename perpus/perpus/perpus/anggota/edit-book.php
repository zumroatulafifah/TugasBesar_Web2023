                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <?php
                            $query = mysqli_query($conn, "SELECT * FROM data_book WHERE id='$_GET[kd]'");
                            $data  = mysqli_fetch_array($query);
                            ?>
                            <!-- </div> -->
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-book.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="judul_buku" type="text" id="judul_buku" class="form-control" autocomplete="off" value="<?php echo $data['judul_buku']; ?>" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Penulis</label>
                                        <div class="col-sm-8">
                                            <input name="penulis" type="text" id="penulis" class="form-control" autocomplete="off" value="<?php echo $data['penulis']; ?>" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="jumlah_halaman" type="text" id="jumlah_halaman" class="form-control" autocomplete="off" value="<?php echo $data['jumlah_halaman']; ?>" required="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <a href="book.php" class="btn btn-sm btn-danger"> Batal</a>
                                        </div>
                                    </div>
