        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <div class="row" style="margin-bottom:5px;">
                    ...
                    <div class="col-md-3">
                        <div class="sm-st clearfix">
                        <span class="sm-st-icon st-violet" style="background-color: orange;"><i class="fa fa-book"></i></span>
                            <div class="sm-st-info">
                    ...
                    <div class="col-md-3">
                        <div class="sm-st clearfix">
                        <span class="sm-st-icon st-violet" style="background-color: pink;"><i class="fa fa-book"></i></span>
                            <div class="sm-st-info">
                                <?php $tampil = mysqli_query($conn, "select * from data_book order by id desc");
                    ...
                    <div class="col-md-3">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <?php $tampil = mysqli_query($conn, "select * from data_artikel order by id desc");
                                $total1 = mysqli_num_rows($tampil);
                                ?>
                                <span><?php echo "$total1"; ?></span>
                                Total Artikel
