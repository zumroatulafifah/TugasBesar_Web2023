                    ...
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-artikel.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="asal" id="asal" required>
                                                ...
                                                <option value="nasional" <?php echo (isset($data['asal']) && $data['asal'] == 'nasional') ? 'selected' : ''; ?>>Nasional</option>
                                                <option value="internasional" <?php echo (isset($data['asal']) && $data['asal'] == 'internasional') ? 'selected' : ''; ?>>Internasional</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <img src="<?php echo isset($data['gambar']) ? $data['gambar'] : ''; ?>" height="250" width="250" alt="Foto Anggota" style="margin-bottom: 10px;" /><br />
